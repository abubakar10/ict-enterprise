    ...
    <section className="it-services-section">
      <div className="it-services-container">
        <div className="left-content">
          <p className="sub-heading">EXPERT IT SERVICES</p>
          <h1>Driving Business Success through Comprehensive Technology Solutions</h1>
        </div>
