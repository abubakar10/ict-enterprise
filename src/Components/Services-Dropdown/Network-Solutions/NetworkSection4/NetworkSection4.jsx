      ...
      <section className="network-section">
        <div className="it-services-container">
          <div className="left-content">
            <p className="sub-heading">WE OFFER</p>
            <h1>Network Solutions: Connectivity, Efficiency, and Security!</h1>
          </div>
...
export default NetworkSection4;
